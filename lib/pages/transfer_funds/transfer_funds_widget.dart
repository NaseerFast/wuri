  ...
  Widget build(BuildContext context) {
    return StreamBuilder<List<WalletsRecord>>(
      ...
      builder: (context, snapshot) {
        ...
        List<WalletsRecord> transferFundsWalletsRecordList = snapshot.data!;
        // Return an empty Container when the item does not exist.
        if (snapshot.data!.isEmpty) {
          return Container();
        }
        final transferFundsWalletsRecord =
            transferFundsWalletsRecordList.isNotEmpty
                ? transferFundsWalletsRecordList.first
                : null;
        return Scaffold(
          key: scaffoldKey,
          backgroundColor: FlutterFlowTheme.of(context).tertiary,
                      ...
                      children: [
                        ...
                        Padding(
                          padding: const EdgeInsetsDirectional.fromSTEB(
                              0.0, 16.0, 0.0, 0.0),
                          child: TextFormField(
                            controller: _model.recipientTextController,
                            focusNode: _model.recipientFocusNode,
                            obscureText: false,
                            ...
                            validator: _model.recipientTextControllerValidator
                                .asValidator(context),
                          ).animateOnPageLoad(
                        ...
                        Padding(
                          ...
                          child: Row(
                            ...
                            children: [
                              ...
                              Text(
                                valueOrDefault<String>(
                                  transferFundsWalletsRecord?.walletBalance
                                      .toString(),
                                  '0',
                                ),
