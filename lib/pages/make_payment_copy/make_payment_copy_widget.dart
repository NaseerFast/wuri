...
import 'make_payment_copy_model.dart';
export 'make_payment_copy_model.dart';
...
class _MakePaymentCopyWidgetState extends State<MakePaymentCopyWidget>
  ...
  void initState() {
    ...
    _model.senderWalleIDTextController ??= TextEditingController();
    _model.senderWalleIDFocusNode ??= FocusNode();

    _model.receiverWalletIDTextController ??= TextEditingController();
    ...
    WidgetsBinding.instance.addPostFrameCallback((_) => setState(() {
          _model.senderWalleIDTextController?.text =
  ...
  Widget build(BuildContext context) {
    return StreamBuilder<List<UserWalletRecord>>(
      stream: queryUserWalletRecord(
      ...
      builder: (context, snapshot) {
        ...
        List<UserWalletRecord> makePaymentCopyUserWalletRecordList =
            snapshot.data!;
        final makePaymentCopyUserWalletRecord =
            makePaymentCopyUserWalletRecordList.isNotEmpty
                ? makePaymentCopyUserWalletRecordList.first
                : null;
        return Scaffold(
          key: scaffoldKey,
          backgroundColor: FlutterFlowTheme.of(context).tertiary,
          body: Form(
            ...
            child: Column(
              ...
              children: [
                    ...
                    child: Padding(
                      ...
                      child: Column(
                        ...
                        children: [
                          ...
                          if (makePaymentCopyUserWalletRecord?.walletId ==
                                  null ||
                              makePaymentCopyUserWalletRecord?.walletId == '')
                            Padding(
                              padding: const EdgeInsetsDirectional.fromSTEB(
                                  0.0, 16.0, 0.0, 0.0),
                              child: TextFormField(
                                controller: _model.senderWalleIDTextController,
                ...
                Text(
                  FFLocalizations.of(context).getText(
                    'icnv2p2m' /* Tap above to complete request */,
                  ),
