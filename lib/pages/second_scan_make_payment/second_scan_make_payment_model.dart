...
import 'second_scan_make_payment_widget.dart' show SecondScanMakePaymentWidget;
import 'package:flutter/material.dart';

class SecondScanMakePaymentModel
    extends FlutterFlowModel<SecondScanMakePaymentWidget> {
  ...
  String? _amountTextControllerValidator(BuildContext context, String? val) {
    if (val == null || val.isEmpty) {
      return FFLocalizations.of(context).getText(
        'yy9i0fqw' /* Please enter an amount */,
      );
    }
