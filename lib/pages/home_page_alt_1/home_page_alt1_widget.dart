...
import '/components/main_action_sheet_widget.dart';
  ...
  Widget build(BuildContext context) {
    return StreamBuilder<List<WalletsRecord>>(
      ...
      builder: (context, snapshot) {
        ...
        List<WalletsRecord> homePageAlt1WalletsRecordList = snapshot.data!;
        // Return an empty Container when the item does not exist.
        if (snapshot.data!.isEmpty) {
          return Container();
        }
        final homePageAlt1WalletsRecord =
            homePageAlt1WalletsRecordList.isNotEmpty
                ? homePageAlt1WalletsRecordList.first
                : null;
        return Scaffold(
          key: scaffoldKey,
          backgroundColor: FlutterFlowTheme.of(context).primaryBackground,
                                  ...
                                  children: [
                                    Text(
                                      valueOrDefault<String>(
                                        homePageAlt1WalletsRecord?.walletBalance
                                            .toString(),
                                        '0',
                                      ),
                                      style: FlutterFlowTheme.of(context)
                                        ...
                                        builder: (context) {
                                          return Padding(
                                            padding: MediaQuery.viewInsetsOf(
                                                context),
                                            child: const MainActionSheetWidget(),
                                          );
                                        },
