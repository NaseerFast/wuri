...
class _MYCardWidgetState extends State<MYCardWidget>
  ...
  void initState() {
    ...
    SchedulerBinding.instance.addPostFrameCallback((_) async {
      _model.daat = await queryWalletsRecordOnce(
        singleRecord: true,
  ...
  Widget build(BuildContext context) {
    return StreamBuilder<List<WalletsRecord>>(
      stream: queryWalletsRecord(
        queryBuilder: (walletsRecord) => walletsRecord.where(
          'user_id',
      ...
      builder: (context, snapshot) {
        ...
        List<WalletsRecord> mYCardWalletsRecordList = snapshot.data!;
        final mYCardWalletsRecord = mYCardWalletsRecordList.isNotEmpty
            ? mYCardWalletsRecordList.first
            : null;
        return Scaffold(
          key: scaffoldKey,
          backgroundColor: FlutterFlowTheme.of(context).primaryBackground,
                              ...
                              child: Column(
                                ...
                                children: [
                                  ...
                                  Padding(
                                    ...
                                    child: Text(
                                      FFLocalizations.of(context).getText(
                                        'cm93vhg8' /* Your latest updates are below. */,
                                      ),
                                      style: FlutterFlowTheme.of(context)
                                          .bodySmall
                                          .override(
                                  ...
                                  children: [
                                    Text(
                                      valueOrDefault<String>(
                                        formatNumber(
                                          mYCardWalletsRecord?.walletBalance,
                          ...
                          Padding(
                            ...
                            child: Row(
                              ...
                              children: [
                                Text(
                                  FFLocalizations.of(context).getText(
                                    'otuhmj6j' /* Recent Card Transactions */,
                                  ),
                                  style: FlutterFlowTheme.of(context)
                                      .bodySmall
                                      .override(
