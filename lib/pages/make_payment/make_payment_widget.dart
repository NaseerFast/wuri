  ...
  Widget build(BuildContext context) {
    return StreamBuilder<List<WalletsRecord>>(
      ...
      builder: (context, snapshot) {
        ...
        List<WalletsRecord> makePaymentWalletsRecordList = snapshot.data!;
        // Return an empty Container when the item does not exist.
        if (snapshot.data!.isEmpty) {
          return Container();
        }
        final makePaymentWalletsRecord = makePaymentWalletsRecordList.isNotEmpty
            ? makePaymentWalletsRecordList.first
            : null;
        return Scaffold(
          key: scaffoldKey,
          backgroundColor: FlutterFlowTheme.of(context).tertiary,
          body: Form(
            ...
            child: Column(
              ...
              children: [
                    ...
                    child: Padding(
                      ...
                      child: Column(
                        ...
                        children: [
                          ...
                          if (makePaymentWalletsRecord?.walletId == null ||
                              makePaymentWalletsRecord?.walletId == '')
                            Padding(
                              padding: const EdgeInsetsDirectional.fromSTEB(
                                  0.0, 16.0, 0.0, 0.0),
                              child: TextFormField(
                                controller:
                                  ...
                                  text: makePaymentWalletsRecord?.walletId,
                                ),
                                  ...
                                  .set(createTransactionsRecordData(
                                    ...
                                    transactionTime:
                                        dateTimeFromSecondsSinceEpoch(
                                            getCurrentTimestamp
                                                .secondsSinceEpoch),
                                    transactionName: 'Transport Fare',
                                    user: makePaymentWalletsRecord.userId,
                ...
                Text(
                  FFLocalizations.of(context).getText(
                    'ufty9336' /* Tap above to complete request */,
                  ),
