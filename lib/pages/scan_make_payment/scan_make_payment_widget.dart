...
import 'scan_make_payment_model.dart';
export 'scan_make_payment_model.dart';

class ScanMakePaymentWidget extends StatefulWidget {
  const ScanMakePaymentWidget({
    super.key,
  ...
  @override
  State<ScanMakePaymentWidget> createState() => _ScanMakePaymentWidgetState();
}

class _ScanMakePaymentWidgetState extends State<ScanMakePaymentWidget>
    with TickerProviderStateMixin {
  late ScanMakePaymentModel _model;
  ...
  void initState() {
    super.initState();
    _model = createModel(context, () => ScanMakePaymentModel());
  ...
  Widget build(BuildContext context) {
    ...
    return StreamBuilder<List<WalletsRecord>>(
      ...
      builder: (context, snapshot) {
        ...
        List<WalletsRecord> scanMakePaymentWalletsRecordList = snapshot.data!;
        // Return an empty Container when the item does not exist.
        if (snapshot.data!.isEmpty) {
          return Container();
        }
        final scanMakePaymentWalletsRecord =
            scanMakePaymentWalletsRecordList.isNotEmpty
                ? scanMakePaymentWalletsRecordList.first
                : null;
        return Scaffold(
          key: scaffoldKey,
          backgroundColor: FlutterFlowTheme.of(context).tertiary,
          body: Form(
            ...
            child: Column(
              ...
              children: [
                    ...
                    child: Padding(
                      ...
                      child: Column(
                        ...
                        children: [
                          ...
                          if (scanMakePaymentWalletsRecord?.walletId == null ||
                              scanMakePaymentWalletsRecord?.walletId == '')
                            Padding(
                              padding: const EdgeInsetsDirectional.fromSTEB(
                                  0.0, 16.0, 0.0, 0.0),
                              child: TextFormField(
                                controller:
                                  ...
                                  text: scanMakePaymentWalletsRecord?.walletId,
                                ),
                ...
                Text(
                  FFLocalizations.of(context).getText(
                    'af29cl03' /* Tap above to complete request */,
                  ),
