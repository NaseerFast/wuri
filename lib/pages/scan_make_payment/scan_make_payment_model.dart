...
import 'scan_make_payment_widget.dart' show ScanMakePaymentWidget;
import 'package:flutter/material.dart';

class ScanMakePaymentModel extends FlutterFlowModel<ScanMakePaymentWidget> {
  ...
  String? _amountTextControllerValidator(BuildContext context, String? val) {
    if (val == null || val.isEmpty) {
      return FFLocalizations.of(context).getText(
        'jn6n3jm4' /* Please enter an amount */,
      );
    }
