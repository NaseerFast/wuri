...
class LightModeTheme extends FlutterFlowTheme {
  ...
  late Color primary = const Color(0xFF0138C9);
  late Color secondary = const Color(0xFFF2A384);
  late Color tertiary = const Color(0xFF2150AD);
  ...
  late Color lineColor = const Color(0xFFEEE8E8);
}
...
class DarkModeTheme extends FlutterFlowTheme {
  ...
  late Color primary = const Color(0x0000968A);
  late Color secondary = const Color(0xFFF2A384);
  late Color tertiary = const Color(0xFF3A66BD);
  ...
  late Color grayLight = const Color(0xFF8B97A2);
  late Color errorRed = const Color(0xFFF06A6A);
  late Color lineColor = const Color(0xFFB69DA9);
}
