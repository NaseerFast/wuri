...
GoRouter createRouter(AppStateNotifier appStateNotifier) => GoRouter(
      ...
      routes: [
        ...
        FFRoute(
          name: 'MY_Card_cO',
          path: '/mYCardcOP',
          builder: (context, params) => const MYCardCOWidget(),
        ),
        FFRoute(
          name: 'MY_Budgets',
          path: '/mYBudgets',
        ...
        FFRoute(
          name: 'QrPayment',
          path: '/qrPayment',
          builder: (context, params) => const QrPaymentWidget(),
        ),
        FFRoute(
        ...
        FFRoute(
          ...
          path: '/makePayment',
          requireAuth: true,
          builder: (context, params) => const MakePaymentWidget(),
        ),
        FFRoute(
          name: 'NewQrPayment',
          path: '/newQrPayment',
          builder: (context, params) => const NewQrPaymentWidget(),
        ),
        FFRoute(
          name: 'scanMakePayment',
          path: '/scanMakePayment',
          builder: (context, params) => ScanMakePaymentWidget(
            recWalletiD: params.getParam(
              'recWalletiD',
              ParamType.String,
            ),
          ),
        ...
        FFRoute(
          name: 'secondScanMakePayment',
          path: '/secondScanMakePayment',
          builder: (context, params) => SecondScanMakePaymentWidget(
            recWalletiD: params.getParam(
              'recWalletiD',
              ParamType.String,
            ),
        ...
        FFRoute(
          ...
          builder: (context, params) => PaymentCompleteWidget(
            paidTo: params.getParam(
              'paidTo',
              ParamType.String,
            ),
            amountPaid: params.getParam(
              'amountPaid',
              ParamType.int,
            ),
          ),
        ...
        FFRoute(
          name: 'QrPaymentCopy',
          path: '/qrPaymentCopy',
          builder: (context, params) => const QrPaymentCopyWidget(),
        ),
        FFRoute(
          name: 'TopUPHistory',
          path: '/topUpHistory',
          builder: (context, params) => const TopUPHistoryWidget(),
        ),
        FFRoute(
        ...
        FFRoute(
          name: 'scanQRP',
          path: '/scanQRP',
          builder: (context, params) => const ScanQRPWidget(),
        ),
        FFRoute(
          name: 'scanMakePaymentTwo',
          path: '/scanMakePaymentTwo',
          builder: (context, params) => ScanMakePaymentTwoWidget(
            recWalletiD: params.getParam(
              'recWalletiD',
              ParamType.String,
            ),
        ...
        FFRoute(
          name: 'makePaymentCopy',
          path: '/makePaymentCopy',
          requireAuth: true,
          builder: (context, params) => const MakePaymentCopyWidget(),
        ),
        FFRoute(
        ...
        FFRoute(
          ...
          builder: (context, params) => params.isEmpty
              ? const NavBarPage(initialPage: 'support_SubmitTicket')
              : const SupportSubmitTicketWidget(),
        ),
        FFRoute(
        ...
        FFRoute(
          name: 'myAcc',
          path: '/myAcc',
          builder: (context, params) => const MyAccWidget(),
        ),
        FFRoute(
          name: 'Cards',
          path: '/cards',
          builder: (context, params) =>
              params.isEmpty ? const NavBarPage(initialPage: 'Cards') : const CardsWidget(),
        ),
        FFRoute(
          name: 'auth_3_Create',
          path: '/auth3Create',
        ...
        FFRoute(
          ...
          builder: (context, params) => const Profile16SimpleProfileWidget(),
        ),
        FFRoute(
          name: 'succ',
          path: '/succ',
          builder: (context, params) => const SuccWidget(),
        ),
        FFRoute(
          name: 'nfcRead',
          path: '/nfcRead',
          builder: (context, params) => const NfcReadWidget(),
        )
  ...
  GoRoute toRoute(AppStateNotifier appStateNotifier) => GoRoute(
        ...
        pageBuilder: (context, state) {
          ...
          final child = appStateNotifier.loading
              ? Container(
                  color: const Color(0xFF070AB7),
                  child: Image.asset(
                    'assets/images/IMG-20240424-WA0009(1).jpg',
                    fit: BoxFit.contain,
                  ),
                )
              : page;
