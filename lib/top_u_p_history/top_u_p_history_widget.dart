...
import 'top_u_p_history_model.dart';
export 'top_u_p_history_model.dart';
...
class _TopUPHistoryWidgetState extends State<TopUPHistoryWidget> {
  ...
  void initState() {
    super.initState();
    _model = createModel(context, () => TopUPHistoryModel());
            ...
            child: Column(
              ...
              children: [
                ...
                Padding(
                  ...
                  child: Text(
                    FFLocalizations.of(context).getText(
                      'm2nnjjj9' /* Below are your most recent ord... */,
                    ),
