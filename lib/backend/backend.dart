...
import 'schema/user_wallet_record.dart';
...
export 'schema/user_wallet_record.dart';
...
/// Functions to query UserWalletRecords (as a Stream and as a Future).
Future<int> queryUserWalletRecordCount({
  DocumentReference? parent,
  Query Function(Query)? queryBuilder,
  int limit = -1,
}) =>
    queryCollectionCount(
      UserWalletRecord.collection(parent),
      queryBuilder: queryBuilder,
      limit: limit,
    );

Stream<List<UserWalletRecord>> queryUserWalletRecord({
  DocumentReference? parent,
  Query Function(Query)? queryBuilder,
  int limit = -1,
  bool singleRecord = false,
    ...
    queryCollection(
      UserWalletRecord.collection(parent),
      UserWalletRecord.fromSnapshot,
      queryBuilder: queryBuilder,
      limit: limit,
      singleRecord: singleRecord,
    );

Future<List<UserWalletRecord>> queryUserWalletRecordOnce({
  DocumentReference? parent,
  Query Function(Query)? queryBuilder,
  int limit = -1,
  bool singleRecord = false,
