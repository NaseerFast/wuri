...
import '/simple_auth_flow_1/empty_state_dynamic_1/empty_state_dynamic1_widget.dart';
          ...
          child: Column(
            ...
            children: [
              Padding(
                ...
                child: Text(
                  FFLocalizations.of(context).getText(
                    'e13qwyse' /* Below are a list of recent tic... */,
                  ),
                  ...
                  builder: (context, snapshot) {
                    ...
                    if (listViewSupportTicketsRecordList.isEmpty) {
                      return Center(
                        child: SizedBox(
                          height: 330.0,
                          child: EmptyStateDynamic1Widget(
                            icon: Icon(
